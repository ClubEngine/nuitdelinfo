...
class AssociationsControllerTest < ActionController::TestCase
  ...
  test "should create association" do
    assert_difference('Association.count') do
      post :create, association: { duck_id: @association.duck_id, gift_id: @association.gift_id, value: @association.value }
    end
  ...
  test "should update association" do
    patch :update, id: @association, association: { duck_id: @association.duck_id, gift_id: @association.gift_id, value: @association.value }
    assert_redirected_to association_path(assigns(:association))
  end
